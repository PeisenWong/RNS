...
//typedef float_data_t POINT_data_t[40][5];
typedef float_data_t POINT_data_t[40][7];
...
struct{
	...
	union{
		...
		struct{
			...
			unsigned motor4_dir :1;
			unsigned motor1_enc :1;
			unsigned motor2_enc :1;
			unsigned motor3_enc :1;
			unsigned motor4_enc :1;
		};
	};
