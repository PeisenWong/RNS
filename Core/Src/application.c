...
//	case RNS_X_Y_POS_VEL:
//		penq->enq_buffer[0].data = pp.real_x;
//		penq->enq_buffer[1].data = pp.real_y;
//		penq->enq_buffer[2].data = fXVel;
//		penq->enq_buffer[3].data = fYVel;
//		break;
//
//	case RNS_ORIENTATION_SPEED:
