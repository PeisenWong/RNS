...
C_SRCS += \
../Core/Src/Moving_Average/mov_ave.c 

OBJS += \
./Core/Src/Moving_Average/mov_ave.o 

C_DEPS += \
./Core/Src/Moving_Average/mov_ave.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/Moving_Average/%.o: ../Core/Src/Moving_Average/%.c Core/Src/Moving_Average/subdir.mk
...
clean: clean-Core-2f-Src-2f-Moving_Average

clean-Core-2f-Src-2f-Moving_Average:
	-$(RM) ./Core/Src/Moving_Average/mov_ave.d ./Core/Src/Moving_Average/mov_ave.o

.PHONY: clean-Core-2f-Src-2f-Moving_Average
